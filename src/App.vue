    ...
    <div class="container">
        ...
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                  <a href="#">
                    <svg class="w-8 h-8 mr-3 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                <div class="flex items-center">
                    <ul class="flex flex-col mt-0 w-full text-sm font-medium lg:mr-6 lg:flex-row">
                        <li class="block border-b dark:border-gray-700 lg:inline lg:border-b-0 lg:mr-8">
                            <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 dark:text-white lg:hover:underline lg:px-0" aria-current="page">About Me</a>
                        </li>
                        <li class="block border-b dark:border-gray-700 lg:inline lg:border-b-0 lg:mr-8">
                            <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 dark:text-white lg:hover:underline lg:px-0">Side Project</a>
                        </li>
                        <!-- <li class="block border-b dark:border-gray-700 lg:inline lg:border-b-0 lg:mr-8">
                            <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 dark:text-white lg:hover:underline lg:px-0"></a>
                        </li> -->
                        <li class="block border-b dark:border-gray-700 lg:inline lg:border-b-0 lg:mr-8">
                            <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 dark:text-white lg:hover:underline lg:px-0">Experience</a>
                        </li>
                        <li class="block border-b dark:border-gray-700 lg:inline lg:border-b-0 lg:mr-8">
                            <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 dark:text-white lg:hover:underline lg:px-0">Education</a>
                        </li>
                        <li class="block border-b dark:border-gray-700 lg:inline lg:border-b-0 lg:mr-8">
                            <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 dark:text-white lg:hover:underline lg:px-0">Self Learn Resources</a>
                        </li>
                        <li class="block border-b dark:border-gray-700 lg:inline lg:border-b-0 lg:mr-8">
                            <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 dark:text-white lg:hover:underline lg:px-0">Contact Me</a>
                        </li>
                        <li class="block lg:inline">
                            <a href="#" class="block py-3 px-4 text-gray-900 lg:py-0 dark:text-white lg:hover:underline lg:px-0">Support Me</a>
                        </li>
                    </ul>
                </div>
            </div>
      ...
      <footer class="bg-white shadow dark:bg-gray-800">
        <div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline">August Wang ™</a>. All Rights Reserved.
        </span>
