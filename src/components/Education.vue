...
<template>
    <div class="pt-20 pb-40 bg-white border-gray-200 px-16 lg:px-16 py-2.5 dark:bg-gray-900 w-full">
    <ol class="relative border-s border-gray-200 dark:border-gray-700 mb-16">                  
        <li class="mb-10 ms-4">
            ...
            Development of an accessorial diagnostic kit for chronic kidney disease through the bacterial flora using R and Python
            </p>
            <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Periodicals:  
            miRTarBase update 2018: a resource for experimentally validated microRNA-target interactions
            </p>
           <div class="flex">
             <a href="https://ndltd.ncl.edu.tw/cgi-bin/gs32/gsweb.cgi?o=dnclcdr&s=id=%22107NCTU5538001%22.&searchmode=basic" target="_blank" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
                    Learn more about Master's thesis
                    <svg class="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                </svg>
                </a>
                <a href="https://pubmed.ncbi.nlm.nih.gov/29126174/" target="_blank" class="ml-3 inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
        ...
        <li class="mb-10 ms-4">
            ...
            Wound Dressing Preparation of Fucoidan
            </p>
        </li>
        <li class="ms-4">
            <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
