    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-16 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-16">
            <div class="grid grid-cols-2 gap-2">
                ...
                <a href="https://experimentlab.online" target="_blank" class="p-8 col-span-2 text-left h-96 bg-[url('https://vueproject.s3.us-west-2.amazonaws.com/pdckd.jpg')] bg-no-repeat bg-cover bg-center bg-gray-500 bg-blend-multiply hover:bg-blend-normal">
                    <h2 class="mb-5 max-w-xl lg:text-3xl lg:mt-0 font-extrabold tracking-tight leading-tight text-white text-xl mt-3">兒童腹膜透析預測模型  <br>串接Google Sheet及撰寫預測模型計算，圖表呈現預測模型</h2> 
                    <h5 class="italic mb-5 max-w-xl text-sm font-extrabold tracking-tight leading-tight text-gray-500 dark:text-gray-400">Ｖue3, Google Sheet API</h5>
                ...
                <a href="https://awtw.github.io/mask-map/" target="_blank" class="p-8 col-span-2 md:col-span-1 text-left h-96 bg-[url('https://vueproject.s3.us-west-2.amazonaws.com/map.png')] bg-no-repeat bg-cover bg-center bg-gray-500 bg-blend-multiply hover:bg-blend-normal">
                    ...
                    <h5 class="italic mb-5 max-w-xl text-sm font-extrabold tracking-tight leading-tight text-gray-500 dark:text-gray-400">Angular, leafletjs</h5>
                ...
                <a href="https://awtw.github.io/resume/#/project/info" target="_blank" class="p-8 col-span-2 md:col-span-1 text-left h-96 bg-[url('https://vueproject.s3.us-west-2.amazonaws.com/resume2023.png')] bg-no-repeat bg-cover bg-center bg-gray-500 bg-blend-multiply hover:bg-blend-normal">
                    ...
                    <h5 class="italic mb-5 max-w-xl text-sm font-extrabold tracking-tight leading-tight text-gray-500 dark:text-gray-400">Angular, sass</h5>
                    <button type="button" class="inline-flex items-center px-4 py-2.5 font-medium text-center text-white border border-white rounded-lg hover:bg-white hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-700">
                        Show more
                    </button>
                </a>
                <a href="https://awtw.github.io/1914_2019/" target="_blank" class="p-8 col-span-2 text-left h-96 bg-[url('https://vueproject.s3.us-west-2.amazonaws.com/1914.png')] bg-no-repeat bg-cover bg-center bg-gray-500 bg-blend-multiply hover:bg-blend-normal">
                    ...
                    <h5 class="italic mb-5 max-w-xl text-sm font-extrabold tracking-tight leading-tight text-gray-500 dark:text-gray-400">Angular, Line API,dialogflow API</h5>
                    <button type="button" class="inline-flex items-center px-4 py-2.5 font-medium text-center text-white border border-white rounded-lg hover:bg-white hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-700">
                        Show more
                    </button>
                </a>
                ...
                <a href="https://awtw.github.io/R_page/"  target="_blank" class="p-8 col-span-2 md:col-span-1 text-left h-96 bg-[url('https://vueproject.s3.us-west-2.amazonaws.com/R.png')] bg-no-repeat bg-cover bg-center bg-gray-500 bg-blend-multiply hover:bg-blend-normal">
                    ...
                    <h5 class="italic mb-5 max-w-xl text-sm font-extrabold tracking-tight leading-tight text-gray-500 dark:text-gray-400">R</h5>
                    <button type="button" class="inline-flex items-center px-4 py-2.5 font-medium text-center text-white border border-white rounded-lg hover:bg-white hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-700">
                        Show more
                    </button>
                </a>
                <a href="https://github.com/awtw/SmartCommunityBackEnd" target="_blank" class="p-8 col-span-2 text-left h-96 bg-[url('https://vueproject.s3.us-west-2.amazonaws.com/smartcommunity.png')] bg-no-repeat bg-cover bg-center bg-gray-500 bg-blend-multiply hover:bg-blend-normal">
                        <h2 class="mb-5 max-w-xl lg:text-3xl lg:mt-0 font-extrabold tracking-tight leading-tight text-white text-xl mt-3">Smart Community BackEnd  <br> 製作智慧園區所需 API 及 worker </h2>
                        <h5 class="italic mb-5 max-w-xl text-sm font-extrabold tracking-tight leading-tight text-gray-500 dark:text-gray-400">.net 6 , rabbitmq, backgroundService</h5>
                        <button type="button" class="inline-flex items-center px-4 py-2.5 font-medium text-center text-white border border-white rounded-lg hover:bg-white hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-700">
                            Show more
                        </button>
                    </a>
