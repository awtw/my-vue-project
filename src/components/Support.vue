...
<template>
    <section class="pt-20 bg-white dark:bg-gray-900 pb-96 h-100 w-full">
        <div class="py-8 px-16 mx-auto max-w-screen-xl lg:py-16 lg:px-16">
            <div class="mx-auto max-w-screen-lg text-left">
                <!-- <h1 class="mb-4 text-xl lg:text-2xl font-extrabold text-primary-600 dark:text-primary-500" >網頁維護中...</h1> -->
                <p class="mb-3 text-xl lg:text-3xl tracking-tight font-bold text-gray-900 md:text-4xl dark:text-white">
                    您可以透過以下方式支持我持續寫專案</p>
